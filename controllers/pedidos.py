...
from schemas.pedido.pedido_schema import PedidoResposta, PedidoSchema, AtualizarPedido, CriarPedido
...
def pegar_pedido_por_id(id: int ,session: Session = Depends(pegar_sessao)):
